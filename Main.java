...
public class Main {
    public static void main(String[] args) {
        ...
        long maxProduct = getMaxProduct(grid);
        System.out.println("Максимальное произведение из 4 чисел = " + maxProduct);

        for (int m = 1; m <= 12; m++) {
            dayOfWeek = (dayOfWeek + daysInMonth(1900, m)) % 7;
        }
        ...
        System.out.println("Количество воскресений, приходящихся на первое число месяца: " + count);
    }

    private static long getMaxProduct(int[][] grid) {
        long maxProduct = 0;
